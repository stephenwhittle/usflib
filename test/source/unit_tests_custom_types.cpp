...
//
//    usf::format_to(str, "Current Date: {}", DateTime::kCurrentDate);
//    std::cout << '\n' << str.data() << '\n';
//
//    usf::format_to(str, "Current Time: {}", DateTime::kCurrentTime);
//    std::cout << str.data() << '\n';
//
//    usf::format_to(str, "Daylight Saving Time: {}", DateTime::kIsDst);
//    std::cout << str.data() << "\n\n";
//  }
//}
//
